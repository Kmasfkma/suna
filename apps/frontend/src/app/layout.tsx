...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'nimind Team', url: 'https://www.nimind.xyz' }],
  creator: 'nimind Team',
  publisher: 'nimind Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>nimind: Your Autonomous AI Worker</title>
        ...
        <meta name="keywords" content="nimind, AI Worker, Agentic AI, Autonomous AI Worker, AI Automation, AI Workflow Automation, AI Assistant, Task Automation" />
        <meta property="og:title" content="nimind: Your Autonomous AI Worker" />
        ...
        <meta property="og:image" content="https://nimind.xyz/banner.png" />
        <meta property="og:url" content="https://nimind.xyz" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="nimind" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="nimind: Your Autonomous AI Worker" />
        ...
        <meta name="twitter:image" content="https://nimind.xyz/banner.png" />
        <meta name="twitter:site" content="@nimind" />
        <link rel="canonical" href="https://nimind.xyz" />
        
        {/* iOS Smart App Banner - shows native install banner in Safari */}
        {!featureFlags.disableMobileAdvertising ? (
          <meta name="apple-itunes-app" content="app-id=6754448524, app-argument=nimind://" />
        ) : null}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['nimind', 'nimind AI', 'nimind: Your Autonomous AI Worker'],
              url: siteMetadata.url,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'nimind'],
